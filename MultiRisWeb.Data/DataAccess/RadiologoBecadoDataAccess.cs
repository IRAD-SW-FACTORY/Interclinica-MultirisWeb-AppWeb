...
// Type: MultiRisWeb.Data.DataAccess.RadiologoBecadoDataAccess
...
{
  public class RadiologoBecadoDataAccess
  {
    public static ResultEjecucion ProcesarRelacionRadiologoBecado(
      long idBecado,
      List<long> radiologos)
    {
      ...
      procedurePrincipal.NombreProcedure = "spDeleteUsuarioRadiologoBecado";
      int num2 = num1;
      int num3 = num2 + 1;
      ...
      foreach (long radiologo in radiologos)
        procedures.Add(new ProcedurePrincipal()
        {
          ...
          NombreProcedure = "spInsertUsuarioRadiologoBecado",
          OrdenEjecucion = num3++,
