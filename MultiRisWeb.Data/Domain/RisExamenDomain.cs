...
// Type: MultiRisWeb.Data.Domain.RisExamenDomain
...
namespace MultiRisWeb.Data.Domain
{
    public class RisExamenDomain
    {
        ...
        public int idUsuarioValidadorExamen { get; set; }
        public string usuarioValidadorExamen { get; set; }

        public RisExamenDomain()
        {
            ...
            this.tecnologo = string.Empty;
            this.asignado = 0;
			this.institucion = "";
            this.idUsuarioValidadorExamen = 0;
            this.usuarioValidadorExamen = string.Empty;
        }
    }
}
