<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Control/Master.Master" AutoEventWireup="true" CodeBehind="ListaUsuario.aspx.cs" Inherits="MultiRisWeb.Web.Usuario.ListaUsuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-3">
            <button class="btn btn-primary" id="btnNuevo" style="width: 136px" onclick="nuevoUsuario(); return false;" data-toggle="modal" data-target="#modalUsuario">Nuevo Usuario</button>
            <br />
            <br />
        </div>
    </div>
