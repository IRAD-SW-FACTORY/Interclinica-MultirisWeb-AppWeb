        ...
        addSearchBox: function (jSelectElem, checklistDivId, w, o) {
            ...
            var initSearchBox = function () {
                ...
                $(checklistDivId).before('<div class="findInList" id="' + jSelectElem.attr('id') + '_findInListDiv">'
                    ...
                    + jSelectElem.attr('id') + '_findInList" class="' + o.cssBlurred + ' ' + o.cssContainsPlaceholder + '" /></div><div class="row"><div class="col"><svg style="cursor: pointer" width="25%" height="100%" viewBox="0 0 16 16" class="bi bi-check" fill="#F39555" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"/></svg><span style="cursor: pointer">Todo</span></div><div class="col"><svg style="cursor: pointer" width="25%" height="100%" viewBox="0 0 16 16" class="bi bi-x" fill="#F39555" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.854 4.146a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708-.708l7-7a.5.5 0 0 1 .708 0z"/><path fill-rule="evenodd" d="M4.146 4.146a.5.5 0 0 0 0 .708l7 7a.5.5 0 0 0 .708-.708l-7-7a.5.5 0 0 0-.708 0z"/>   </svg><span style="cursor: pointer">Nada</span></div></div>');
