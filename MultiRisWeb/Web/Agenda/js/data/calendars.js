...
(function() {
    ...
    calendar.name = 'Médica';
    calendar.color = '#ffffff';
    calendar.bgColor = '#22B098';
    calendar.dragBgColor = '#22B098';
    calendar.borderColor = '#22B098';
    addCalendar(calendar);

    calendar = new CalendarInfo();
    id += 1;
    calendar.id = String(id);
    calendar.name = 'Radiológica';
    calendar.color = '#ffffff';
    calendar.bgColor = '#F07D00';
    calendar.dragBgColor = '#F07D00';
    calendar.borderColor = '#F07D00';
    addCalendar(calendar);
