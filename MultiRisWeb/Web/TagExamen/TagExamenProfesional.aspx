<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Control/Master.Master" AutoEventWireup="true" CodeBehind="TagExamenProfesional.aspx.cs" Inherits="MultiRisWeb.Web.TagExamen.TagExamenProfesional" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row pt-5">
        <div class="col-md-10 col-12 text-left">
            <h2 class="col-12" style="position: absolute; margin-left: 1%;" id="tituloDocumentosLegales">TAG Personal</h2>
        </div>
            ...
            <table style="width: 100% !important; overflow-y: scroll" class="table table-striped table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 15%" class="text-center oculta-columna">Estado</th>
    ...
    <script type="text/javascript">
        ...
        function Insertar() {
            ...
            $.ajax({
                type: "POST",
                url: "../TagExamen/TagExamenProfesional.aspx/Insertar",
        ...
        function BuscarTag() {
            ...
            $.ajax({
                type: "GET",
                url: "../TagExamen/TagExamenProfesional.aspx/Listar",
                contentType: "application/json; charset=utf-8",
        ...
        function GetTag(id) {           
            ...
            $.ajax({
                type: "GET",
                url: "../TagExamen/TagExamenProfesional.aspx/Get",
                contentType: "application/json; charset=utf-8",
                data: { 'id': id },
                datatype: "json",
                async: false,
        ...
        function Editar(idTag) {
            ...
            $.ajax({
                type: "POST",
                url: "../TagExamen/TagExamenProfesional.aspx/Update",
                contentType: "application/json; charset=utf-8",
                data: jsdata,
                datatype: "json",
                async: false,
