<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Autenticacion.aspx.cs" Inherits="MultiRisWeb.Web.Control.Autenticacion" %>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form id="form1" runat="server">
                                        ...
                                        <div class="form-outline mb-4 text-center">
                                            <p>
                                                Hola! <strong>
                                                    <asp:Label runat="server" ID="lblUsuario"></asp:Label></strong>, favor ingresar c&oacute;digo SMS que fue enviado al celular 
                                                <strong>
                                                    <asp:Label runat="server" ID="lblCelular"></asp:Label></strong>.
                                            </p>
                                        </div>
                                        <div class="pt-1 mb-4 text-center">
                                            <label class="col-12"><b>Ingrese c&oacute;digo SMS</b></label>
                                            <div class="row">
                                                <div class="col-3">
                                                    &nbsp;
                                                </div>
                                                 <div class="col-6">
                                                     <asp:TextBox runat="server" ID="txtCodigoSms" CssClass="form-control" MaxLength="5"></asp:TextBox>
                                                </div>
                                                 <div class="col-3">
                                                    &nbsp;
                                                </div>
                                        ...
                                        <div class="pt-1 mb-4 text-center">
                                            <asp:Button runat="server" Text="Validar Código" ID="btnValidar" CssClass="btn btn-primary" OnClick="btnValidar_Click" />
                                        </div>
                                        <div class="pt-1 mb-4 text-center">
